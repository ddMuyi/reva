...
const SideBar = ({open, toggleHandler}) =>{
  ...
  return (
    <div className={`transition duration-500 ease-in-out bg-charcoal-primary ${width} h-full hidden sm:flex relative`}>
      <div className="absolute z-20 w-8 h-8 bg-white rounded-full top-0 -right-4 flex border-green-800 border items-center justify-center cursor-pointer" onClick={()=>{toggleHandler()}}>
